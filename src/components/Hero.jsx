...
function Hero() {
  return (
    <section className="bg-gradient-to-br from-black via-black/50 to-black w-full py-16 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center md:px-16 gap-8">
        <div className="space-y-6">
          ...
          <p className="text-gray-400 leading-relaxed text-lg max-w-lg">
            Motivated engineering graduate seeking an entry-level role in the IT
            domain, with strong foundations in programming, data structures, and
            problem-solving. Skilled in developing efficient and scalable
            software solutions, with hands-on experience in modern technologies
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            ...
            <a
              href="https://drive.google.com/uc?export=download&id=1fKiAk26_1P7kU3cIdrkVIYZwbFaPh04g"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-200 text-black px-8 py-3 rounded-full font-semibold hover:bg-gray-400 hover:text-white transition"
            >
              Download Resume
            </a>
            <a
        ...
        <div className="flex justify-center mt-12 md:mt-0">
          <div className="relative">
            ...
            <img
              src={profileImg}
              alt="profile"
              className="relative w-80 md:w-96 rounded-2xl shadow-2xl border-4 border-gray-800 object-cover"
            />
          </div>
        </div>
      </div>
